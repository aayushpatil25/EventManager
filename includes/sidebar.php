...
$user_email = isset($_SESSION['email']) ? $_SESSION['email'] : 'use1@gmail.com';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <div class="logo-container">
                <a href="dashboard.php"><img src="uploads/FinalLogos.png" alt=""></a>    
            </div>
        ...
        <div class="nav-container">
            <ul class="nav-menu">
                ...
                <li class="nav-item">
                    <a href="event_coordination.php" class="nav-link">
                        <span class="nav-icon">
                            <i class="fa-solid fa-list-check"></i>
                        </span>
                        <span class="nav-text">Event Coordination</span>
                    </a>
                </li>
    ...
    <nav class="topbar">
        <div class="topbar-right">
            ...
            <div class="profile-dropdown" id="profileDropdown">
                <!-- <div class="user_profile-dropdown-header">
                    <div class="user-info">
                        <div class="user-name"><?php echo htmlspecialchars($username); ?></div>
                        <div class="user-role"><?php echo htmlspecialchars($user_email); ?></div>
                    </div>
                </div> -->
